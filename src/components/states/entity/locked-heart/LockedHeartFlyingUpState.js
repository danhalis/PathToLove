import { CANVAS_HEIGHT, CANVAS_WIDTH, images, keys, timer } from "globals";
...
export default class LockedHeartFlyingUpState extends State {
	
    static NAME = "locked-heart-flying-up-state";

	static ANIMATION_FRAMES = [0, 1, 2, 3, 4, 5];
	static ANIMATION_INTERVAL = 0.1;

    static Y_LIMIT = CANVAS_HEIGHT * 0.2;
	...
	constructor(heart) {
        ...
        this.heart = heart;
        this.name = LockedHeartFlyingUpState.NAME;
        this.sprites = null;
	...
	enter(params) {
        ...
        this.heart.setAnimation(new Animation(
            LockedHeartFlyingUpState.ANIMATION_FRAMES,
            LockedHeartFlyingUpState.ANIMATION_INTERVAL
        ));
